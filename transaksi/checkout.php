        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <form action="p_checkout.php" method="POST">
                               <div class="from-group"><label for="">ID Transaksi</label><input type="text" name="id_transaksi" class="form-control" value="<?php echo $r['id_transaksi'] ?>" readonly></div>
                                <div class="form-group">
                                    ...
                                    <select name="id_pengunjung" class="form-control" readonly>
                                        <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_ci" class="form-control" value="<?php echo $r['tgl_ci'] ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="">Tanggal Check Out</label>
                                    <input type="date" name="tgl_co" class="form-control" value="<?php echo $r['tgl_co'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="">Harga Kamar</label>
                                    <input type="text" class="form-control" name="harga" value="<?php echo $r['harga'] ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="">Bayar</label>
                                    <input type="number" name="bayar" class="form-control" min=0 value="<?php echo $r['bayar'] ?>">
                                </div>
                                <div class="form-group">
